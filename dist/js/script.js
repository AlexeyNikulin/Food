...
function cards() {
  ...
  Object(_server_server__WEBPACK_IMPORTED_MODULE_0__["getResource"])('http://localhost:3000/menu').then(data => {
    data.forEach(({
      img,
      altimg,
      title,
...
/* harmony import */ var _valid_form__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./valid-form */ "./src/js/modules/valid-form.js");
/* harmony import */ var _server_server__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../server/server */ "./src/js/server/server.js");
...
function form() {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      if (Object(_valid_form__WEBPACK_IMPORTED_MODULE_1__["default"])(form)) {
        return false;
      }
      ...
      Object(_server_server__WEBPACK_IMPORTED_MODULE_2__["postData"])('http://localhost:3000/requests', JSON.stringify(obj)).then(data => {
        console.log(data);
